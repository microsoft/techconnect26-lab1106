...
3. Wait for your Development Environment to be created
4. Choose United States from the list of country/region
5. Don't Mark "I will receive information, tips, and offers about Microsoft Copilot Studio" checkbox
6. Click **Get Started**
7. Skip the Welcome window
8. Click on three dots on the top right
9. Click **X Cancel agent creation**
...
11. On the left ribbon click on the three dots if don't see the **Solutions** icon
12.  Click on **Solutions** (New tab is open in the Edge browser)
13.  Click **Import Solution** from the command bar
14.  Click **Browse** to select the solution to import
15.  Select the zip file **IntakeAgent_1_0_0_7.zip** solution package
16. Click **Open**
17. Click **Next**
18. Click **Next**
19. When green checks are in all services then click **Import**

Let's continue by importing the **DesignAgent_1_0_0_11** package
...
22. Click **Next**
23. Click **Next**
24. When green checks are in all services then click **Import**

Wait for the packages to be imported, once imported you will see the status change to **Solution "IntakeAgent" imported successfully with warnings**, with the same status for the Design-Agent package.
...
3. Validate there are 2 agents (App Intake Agent v1.3.4 and Azure Architecture Expert v0.6.1) 
4. Click on **App Intake Agent v1.3.4**
5. Click on **Tools** on the top ribbon
6. Click on **Send and Email (V2)** connector Name
