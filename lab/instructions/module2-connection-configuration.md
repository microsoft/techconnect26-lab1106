...
3. **Save Design Document** flow
   1. Select **Flows** in the left sidebar in Copilot Studio. On the page that opens up, hover over the row for **Save Design Document**, select the **ellipsis (...)** to open a context menu, and select **Edit agent flow** option:
